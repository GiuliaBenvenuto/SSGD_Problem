...
# Load the CSV file
mean_times_df = pd.read_csv('../distances/mean_times_mechanical.csv')  # Make sure to set the correct path to your CSV file
...
# Save the plot
plt.savefig('mesh_size_vs_query_MECHANIC.png')
...
# Save the plot
plt.savefig('mesh_size_vs_preprocessing_MECHANIC.png')
