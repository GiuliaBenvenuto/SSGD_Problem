...
# Load the CSV file
mean_times_df = pd.read_csv('../distances/mean_times_mechanical_MODIFIED.csv')  # Make sure to set the correct path to your CSV file
...
# Save the plot
plt.savefig('mesh_size_vs_query_MODIFIED.png')
...
# Save the plot
plt.savefig('mesh_size_vs_preprocessing_MODIFIED.png')
