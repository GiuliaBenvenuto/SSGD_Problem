...
def process_directory(directory, ground_truth_file):
    ...
    df.to_csv(os.path.join(".", 'structured_smape_results.csv'), index=False)

# Specify the directory where your files are located and the ground truth file name
directory = '../DISTANCES/blub_distances_OK'  # Adjust the path as needed
ground_truth_file = '5_blub_VTP_663.txt'  # Adjust the file name as needed
