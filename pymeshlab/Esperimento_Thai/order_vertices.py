...
def process_meshes(input_folder, output_folder):
    ...
    file_paths = [os.path.join(input_folder, f'thai{i}.obj') for i in range(9)] 
    ...
    for i, mesh in enumerate(mapped_meshes):
        save_mesh(mesh, os.path.join(output_folder, f'M{i}_ord.obj'))

    print("All meshes processed and saved.")

if __name__ == "__main__":
    input_folder = "thai_decimated"
    output_folder = "thai_ordered"
