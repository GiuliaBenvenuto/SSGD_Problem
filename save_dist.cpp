...
const string OUTPUT_PATH = "../pymeshlab/Esperimento_K_Steiner/DIST/n";
...
int main(int argc, char **argv) {
    ...
    folder_path = "../pymeshlab/Esperimento_1/data/simplified/blub_subdiv";
    vv_sources = {100};
    ...
    folder_path = "../pymeshlab/Esperimento_1/data/simplified/bob_subdiv";
    vv_sources.clear();
    vv_sources = {100};
    ...
    folder_path = "../pymeshlab/Esperimento_1/data/bunny";
    vv_sources.clear();
    vv_sources = {100};
